        ...
        <div class="container">
            <div class="row margin-bottom-lg">
              <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
                    <img src="<?php bloginfo('template_directory'); ?>/img/gota.png" alt="Water Planet" width="60%" class="center-block vertical visible-md visible-lg" >
                </div>
                ...
                <div class="col-xs-12 margin-bottom-lg">
                    <img src="<?php bloginfo('template_directory'); ?>/img/gota.png" alt="Water Planet" width="40%" class="center-block visible-xs visible-sm" >
                </div>
