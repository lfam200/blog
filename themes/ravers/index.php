    ...
    <div class="title-container">
      ...
      <div class="col-xs-12 text-center margin-bottom-lg margin-top-lg">
        <a href="https://www.youtube.com/channel/UC1_oGFUL3_FCH_7_8g_kLRQ" target="_blank">
          <button type="button" class="btn btn-success btn-lg textvideo text-uppercase">Watch our videos</button>
        </a>
      </div>
      <!-- Fin Boton -->
    </div>
  ...
  <div class="container">
    ...
    <div class="row margin-bottom-lg">
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <h3 class="title-white text-center text-uppercase" >explore</h3>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <h3 class="title-white text-center text-uppercase" >charities</h3>
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <h3 class="title-white text-center text-uppercase" >kandi trade</h3>
...
<div class="white margin-bottom">
  <div class="container">
    ...
    <div class="row visible-md visible-lg">
      ...
      <div class="col-sm-3">
        <img src="https://pbs.twimg.com/profile_images/3314948403/13fc87b5224b432a41bfdf278965a9c7.jpeg" alt="@alevittoriag" width="70%" class="center-block img-circle" >
      ...
      <div class="col-sm-3">
        <img src="https://pbs.twimg.com/profile_images/662357824274608128/TKH1xXMl.jpg" alt="@Claudioiam" width="70%" class="center-block img-circle" >
      ...
      <div class="col-sm-3 margin-bottom-lg">
        <img src="https://pbs.twimg.com/profile_images/1301175628/161257_1467441613_5932411_q.jpg" alt="@JeffObert34" width="70%" class="center-block img-circle" >
        <h4 class="text-center"><a href="https://twitter.com/JeffObert34">@JeffObert34</a></h4>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-6 col-md-5 col-lg-6">
        ...
        <div class="col-xs-12 text-center margin-bottom-lg">
          <a href="<?php bloginfo('home') ?>/category/donate#sc_uea_custom_amount_2">
