if (typeof JSON !== "object") {
    ...
    function quote(string) { escapable.lastIndex = 0; return
    escapable.test(string) ? '"' + string.replace(escapable, function(a) { var
    c = meta[a]; return typeof c === "string" ? c : "\\u" + ("0000" +
        ...
        (function() {
            ...
            Button = function() {
                ...
                function Button(scriptEl, app) {
                    ...
                    (_base = this.options).label || (_base.label = "Give by Card");
                ...
                Button.prototype.render = function() {
                    ...
                    this.$style.setAttribute("href", "https://checkout.stripe.com/v3/checkout/button-qpwW2WfkB0oGWVWIASjIOQ.css");
            ...
            Checkout = function() {
                ...
                function Checkout(tokenCallback, host) {
                    ...
                    if (helpers.isFallback()) {
                        ...
                        path = "https://checkout.stripe.com/v3/fallback/yUuBkxNL5Lp4aNJlPLA.html"
                    } else {
                        path = "https://checkout.stripe.com/v3/NP0qnNLetax1wrwrrCwFg.html";
                        if (Math.random() < .5) {
                            path = "https://checkout.stripe.com/v3/var-FvA1twicEeFUOdUzytgLA.html"
                        }
                ...
                Checkout.prototype.open = function(options) {
                    ...
                    iframeFallback = function() {
                        ...
                        this.view = new IframeView(this.onToken, this.host, "https://checkout.stripe.com/v3/NP0qnNLetax1wrwrrCwFg.html");
